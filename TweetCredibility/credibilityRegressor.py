...
def credibility_score(tweet_id):
    ...
    model = pickle.load(open("/Users/cosimocorbisiero/Documents/GitHub/FakeNewsDetection/TweetCredibility/regressor",'rb'))
...
if __name__ == "__main__":
    ...
    #print(credibility_score("1580916533181952004")[0])
